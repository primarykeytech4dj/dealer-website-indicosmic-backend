...
export  class CompanyEditTab extends React.Component {
    ...
    companydata(){
            ...
            this.apiCtrl.callAxiosGet(`company/view`).then((response)=>{
    ...
    render(){  
        ...
        return(<>
            ...
            <BreadCrumb breadcrumb={"Company Profile"} />
...
export default withRouter(CompanyEditTab)