        ...
        this.apiCtrl.callAxios(
            ...
            if(res.success==true){
                res.data.map((value)=>{  
                    ...
                    typedata ={...typedata, [value.type]:value.type}
                      //vehiclemodel = [...vehiclemodel, { value: value.model_code, label: value.name,  }]
                  })  
                  this.setState(old=>({...old,type:typedata}))
            }
            ...
            <Box sx={{ width: '100%', height: '100%', typography: 'body1', backgroundColor: 'white', borderRadius: "6px", padding: '2%' }}>
                ...
                <div className="row mb-3">
                    <div className="col-md-4 mb-3">
                        <MaterialTextField readOnly={ true}  name="company_name" value={this.state.comapnyDetails.company_name ? this.state.comapnyDetails.company_name : ""} label="Company Name" size={"small"} fullWidth onChange={handleChange}
                            helperText={
                    ...
                    <div className="col-md-4 mb-3">
                        <MaterialTextField readOnly={ true}  fullWidth value={this.state.comapnyDetails.domain ? this.state.comapnyDetails.domain : ""} placeholder={"domain"} size={"small"} name="domain" label="Domain: eg(sub.domain.com)" onChange={handleChange}
                            helperText={
                    ...
                    <div className="col-md-4 mb-3">
                        <MaterialTextField readOnly={ true}  fullWidth value={this.state.comapnyDetails.sub_domain ? this.state.comapnyDetails.sub_domain : ""} size={"small"} placeholder={"sub"} name="sub_domain" label="Sub Domain: eg(sub.domain.com)" onChange={handleChange}
                            helperText={
                    ...
                    <div className="col-md-4 mb-3">
                        <MaterialTextField readOnly={ true}  fullWidth size={"small"} value={this.state.comapnyDetails.website ? this.state.comapnyDetails.website : ""} placeholder={"website"} name="website" label="Website" onChange={handleChange}
                        //   helperText={
                    ...
                    <div className="col-md-4 mb-3">
                        <MaterialSelect readOnly={ true}  data={this.state.type} value={this.state.comapnyDetails.type ? this.state.comapnyDetails.type : ""} fullWidth size={"small"} name="type" label="Type" onChange={handleChange}
                            helperText={
